<?php	
	...
	if (empty($_POST['title'])) {
		...
		$sql="insert into ticket (title,description,category_id,project_id,priority_id,user_id,kind_id,created_at) value (\"$title\",\"$description\",\"$category_id\",\"$empresa\",$priority_id,$user_id,$kind_id,$created_at)";
